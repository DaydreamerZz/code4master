...
//        System.out.println(Arrays.toString(array1));
        ...
        seperateByMoveSmallerToHead(array2, 5);
        System.out.println(Arrays.toString(array2));
        //[4, 2, 1, 0, 2, 8, 5, 9], 如果pivot在数组中，那么不能很好的处理。

        int[] array3 = {4, 3, 9, 1, 0, 8, 5, 2}; //[4, 2, 2, 1, 0, 5, 8, 9]
     ...
     */
    private static void seperateByMoveSmallerToHead(int[] array2, int key) {
        int lessIndex = -1;
